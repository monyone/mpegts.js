...
class FLVDemuxer {
    ...
    _parseVideoData(arrayBuffer, dataOffset, dataSize, tagTimestamp, tagPosition) {
        ...
        } else if (codecId === 13) { // AV1
            this._parseAV1VideoPacket(arrayBuffer, dataOffset + 1, dataSize - 1, tagTimestamp, tagPosition, frameType);
        } else {
    ...
    _parseAV1VideoPacket(arrayBuffer, dataOffset, dataSize, tagTimestamp, tagPosition, frameType) {
        if (dataSize < 4) {
            Log.w(this.TAG, 'Flv: Invalid AV1 packet, missing HEVCPacketType or/and CompositionTime');
            return;
        }
